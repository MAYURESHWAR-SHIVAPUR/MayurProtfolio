  ...
  return (
    <div className={HomeCss.outer}>
      <div className={HomeCss.child1}>
        ...
        <br />
        <h3>Jr. <span style={{ textOverflow: "hidden" }}>FrontEnd Developer</span></h3>
        <br /><br />
        <h4>Quick Intro</h4>
        <br />
        ...
        <a href="https://wa.me/919380183660?text=Hello%20I%20want%20to%20talk%20to%20about%20Hireing!" target="_blank">
